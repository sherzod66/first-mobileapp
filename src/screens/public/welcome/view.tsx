		...
		<View>
			...
			>
				...
				<View style={styles.textContainer}>
					...
					<Text style={styles.textImage}>которые люди тратят на малоэффективные методы...</Text>
				</View>
				<View style={styles.textContainer}>
					<View style={{ flexDirection: 'row' }}>
						<Text style={styles.fit}>Fit</Text>
	...
	return (
		<View>
			...
			>
				...
				<View style={styles.textContainer}>
					<Text style={styles.textImage}>
						Доступ к БАЗЕ УПРАЖНЕНИЙ, где подробно показана ТЕХНИКА ВЫПОЛНЕНИЯ упражнений на все
						ЧАСТИ ТЕЛА...
					</Text>
				</View>
				<View style={styles.textContainer}>
	...
	return (
		<View>
			...
			>
				...
				<View style={styles.textContainer}>
					<Text style={styles.textImage}>
						ДНЕВНИК ТРЕНИРОВОК, который является ВАЖНОЙ частью тренировочного процесса и позволяет
						АНАЛИЗИРОВАТЬ его, тем самым помогая принимать правильные решения в дальнейших
						действиях...
					</Text>
				</View>
				<View style={styles.textContainer}>
					<Text style={styles.textImage}>
						КОНТРОЛЬ ПИТАНИЯ (Ккал и БЖУ), возможность добиваться поставленной цели не ограничивая
						себя в каких либо продуктах...
					</Text>
				</View>
				<View style={styles.textContainer}>
					<Text style={styles.textImage}>
						САМОСТОЯТЕЛЬНО определять нужное количество Ккал и БЖУ, составлять себе планы питания из
						любимых продуктов...
					</Text>
				</View>
			</ImageBackground>
	...
	return (
		<View>
			...
			>
				...
				<View style={styles.textContainer}>
					<Text style={styles.textImage}>
						Возможность найти себе НАСТАВНИКА, ТРЕНЕРА, который поможет вам в достижении ваших
						целей...
					</Text>
				</View>
				<View style={styles.textContainer}>
					...
					<Text style={styles.textImage}>
						пользователю выстроить ГРАМОТНУЮ СТРАТЕГИЮ действий на пути к поставленной цели и
			...
			{showedContent > 0 && (
				<View>
					<View style={styles.bottom}>
						<View style={{ flexDirection: 'row' }}>
							<View
								style={[styles.circle, showedContent === 1 ? styles.bgLight2 : styles.bgLight1]}
							/>
							<View
								style={[styles.circle, showedContent === 2 ? styles.bgLight2 : styles.bgLight1]}
							/>
							<View
								style={[styles.circle, showedContent === 3 ? styles.bgLight2 : styles.bgLight1]}
							/>
							<View
								style={[styles.circle, showedContent === 4 ? styles.bgLight2 : styles.bgLight1]}
							/>
						</View>
					</View>
					<View style={{ marginVertical: 20 }}>
						<TouchableOpacity activeOpacity={0.8} onPress={onPress} style={styles.btn}>
							{showedContent === 1 ? <Text style={styles.btnText}>{t('what-you-get')}</Text> : null}
							{showedContent === 2 ? (
								<Text style={styles.btnText}>Что ещё даст мне FitMe?</Text>
							) : null}
							{showedContent === 3 ? <Text style={styles.btnText}>Так же FitMe даёт</Text> : null}
							{showedContent === 4 ? (
