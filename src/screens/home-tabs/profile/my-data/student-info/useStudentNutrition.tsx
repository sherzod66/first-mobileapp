...
export const useStudentNutrition = (apprenticeId = '') => {
	const navigation = useNavigation<MyNutritionScreenNavigationProp>()
	const [isLoading, setIsLoading] = useState<boolean>(false)
	const [user, setUser] = useState<User | undefined>(undefined)
	const [schemaNutritions, setSchemaNutritions] = useState<SchemaNutrition[] | undefined>(
	...
	const getUser = async () => {
		try {
			...
			setSchemaNutritions(req.data.schemaNutritions)
			setUser(req.data)
			setIsLoading(false)
		} catch (e) {
			setIsLoading(false)
