...
const titles = ['Сегодня', 'Вчера', 'Текущая неделя', 'Прошлая неделя', 'Месяц']
			...
			<ScrollView>
				{activeTab === 0 || activeTab === 1 ? (
					<View style={styles.dateRow}>
						...
						{activeTab === 0 && (
							<TouchableOpacity onPress={onRecommendationPress} style={styles.recommendation}>
								<Text style={styles.recommendationText}>{t('recomendation-by-user')}</Text>
							</TouchableOpacity>
						)}
					</View>
				) : null}
