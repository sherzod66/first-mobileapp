...
const longText = 'Вывести все приемы пищи в одно окно и подогнать под нужное кол-во Ккал и БЖУ'
			...
			<ScrollView showsVerticalScrollIndicator={false}>
				...
				<View style={styles.mh25}>
					<ButtonPrimary
						...
						multiline
						text={longText}
						style={[styles.btn3, receptions.some(r => !r) && styles.borderGrey]}
						textStyle={[styles.text2, receptions.some(r => !r) && styles.textGrey]}
