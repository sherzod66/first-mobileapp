	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.headerContainer}>
				<Image style={styles.image} source={{ uri: imageLink(trainer.avatar) }} />
				...
				<View style={{ justifyContent: 'center' }}>
					<Text style={[styles.textOld, { marginBottom: 10 }]}>Связаться с тренером:</Text>
					<View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
						...
						<TouchableOpacity onPress={openLink(trainer.instagramLink)} activeOpacity={0.7}>
			...
			<ScrollView>
				<View>
					...
					<View style={styles.about}>
						{trainer.isPhoneNumber ? (
							...
							<Text style={styles.aboutText}>Тренер решил скрыть номер телефона</Text>
						)}
					</View>
				...
				<View style={{ marginHorizontal: 15, marginBottom: 100 }}>
					<TouchableOpacity style={{ marginBottom: 40, marginTop: 20 }} activeOpacity={0.7}>
						<ButtonPrimary
